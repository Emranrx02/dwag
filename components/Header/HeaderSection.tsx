...
export default function HeaderSection() {
  return (
    <div className="bg-[#E5A220]   relative w-full">
      <div className="pt-[16%] px-8 relative z-10   xl:gap-10 text-2xl flex-col xl:flex-row flex items-center">
        <Image
          src={"/dog-2.png"}
          width={500}
          className="xl:w-[50%] w-full xl:order-1 order-2 z-0  bottom-0 "
          height={500}
          alt="water dog"
        />
